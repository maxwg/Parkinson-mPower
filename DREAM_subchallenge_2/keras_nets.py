...
def challenge2ConvLSTM_wavenet(spectral_dim, walk_dim_norm, walk_dim, num_classes=1):
    ...
    spectral_model = LSTM(24, return_sequences=True, input_shape=spectral_dim)(spectral_input)
    ...
    spectral_model = Conv1D(32, 5, kernel_initializer='he_uniform', padding='same')(spectral_model)
    spectral_model = Activation('relu')(spectral_model)
    ...
    spectral_model = Conv1D(32, 5, kernel_initializer='he_uniform', padding='same')(spectral_model)
    spectral_model = Activation('relu')(spectral_model)
    spectral_model = Dropout(0.4)(spectral_model)
    spectral_model = BatchNormalization()(spectral_model)
    ...
    A, B = wavenetBlock(24,5,2)(walk_input_norm)
    skip_connections = [B]
    for i in range(16):
        A, B = wavenetBlock(24, 5, 2**((i+2)%8))(A)
        skip_connections.append(B)
    ...
    walk_input = Input(walk_dim, name="walk_input")
    walk_model = LSTM(24, return_sequences=True, input_shape=walk_dim)(walk_input)
    walk_model = Activation('relu')(walk_model)
    walk_model = Dropout(0.1)(walk_model)
    walk_model = BatchNormalization()(walk_model)
    walk_model = LSTM(24, return_sequences=True, input_shape=walk_dim)(walk_input)
    ...
    walk_model = Dropout(0.1)(walk_model)
    walk_model = BatchNormalization()(walk_model)
    walk_model = LSTM(24, return_sequences=True, input_shape=walk_dim)(walk_model)
    walk_model = Activation('relu')(walk_model)
    walk_model = BatchNormalization()(walk_model)
    ...
    walk_model = Activation('relu')(walk_model)
    walk_model = BatchNormalization()(walk_model)
    walk_model = Dropout(0.4)(walk_model)
    walk_out = Flatten()(walk_model)
